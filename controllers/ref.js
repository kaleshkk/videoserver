...
function callAction() {
  ...
  const localServer = {'iceServers': [{'urls': 'stun:stun.l.google.com:19302'}]};  // Allows local server for RTC server configuration.

  // Create peer connections and add behavior.
  localPeerConnection = new RTCPeerConnection(localServer);
  ...
  const remoteServer = {'iceServers': [{'urls': 'stun:stun.l.google.com:19302'}]};  // Allows remote server for RTC server configuration.

  remotePeerConnection = new RTCPeerConnection(remoteServer);
